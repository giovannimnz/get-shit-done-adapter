...
when-to-use: Analyzes extracted session messages across 8 behavioral dimensions to produce a scored developer profile with confidence levels and evidence. Spawned by profile orchestration workflows.
allowed-tools: 
model: inherit
inherit-tools: true
inherit-mcps: true
...
<!-- source: .claude/agents/gsd-user-profiler.md -->
...
<reference>
@/home/ubuntu/docker/AtiusCapital/.claude/get-shit-done/references/user-profiling.md
...
Read the user-profiling reference document at `/home/ubuntu/docker/AtiusCapital/.claude/get-shit-done/references/user-profiling.md` to load:
