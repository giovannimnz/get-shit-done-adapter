...
when-to-use: Researches how to implement a phase before planning. Produces RESEARCH.md consumed by gsd-planner. Spawned by /gsd-plan-phase orchestrator.
allowed-tools: 
model: inherit
inherit-tools: true
inherit-mcps: true
...
```bash
node "/home/ubuntu/docker/AtiusCapital/.claude/get-shit-done/bin/gsd-tools.cjs" websearch "your query" --limit 10
```
...
@/home/ubuntu/docker/AtiusCapital/.claude/get-shit-done/references/thinking-models-research.md
...
```bash
node "/home/ubuntu/docker/AtiusCapital/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs($PHASE): research phase domain" --files "$PHASE_DIR/$PADDED_PHASE-RESEARCH.md"
```
