---
agent-type: gsd-debugger
name: gsd-debugger
description: Investigates bugs using scientific method, manages debug sessions, handles checkpoints. Spawned by /gsd-debug orchestrator.
when-to-use: Investigates bugs using scientific method, manages debug sessions, handles checkpoints. Spawned by /gsd-debug orchestrator.
allowed-tools: 
model: inherit
inherit-tools: true
inherit-mcps: true
...
<!-- source: .claude/agents/gsd-debugger.md -->
...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = /home/ubuntu/docker/AtiusCapital/.claude
                  → checks /home/ubuntu/docker/AtiusCapital/.claude/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = /home/ubuntu/docker/AtiusCapital/.claude/get-shit-done
                  → writes to /home/ubuntu/docker/AtiusCapital/.claude/get-shit-done/hooks/
...
@/home/ubuntu/docker/AtiusCapital/.claude/get-shit-done/references/thinking-models-debug.md
...
- Read @/home/ubuntu/docker/AtiusCapital/.claude/get-shit-done/references/common-bug-patterns.md
...
```bash
INIT=$(node "/home/ubuntu/docker/AtiusCapital/.claude/get-shit-done/bin/gsd-tools.cjs" state load)
...
```bash
node "/home/ubuntu/docker/AtiusCapital/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs: resolve debug {slug}" --files .planning/debug/resolved/{slug}.md
```
...
```bash
node "/home/ubuntu/docker/AtiusCapital/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs: update debug knowledge base with {slug}" --files .planning/debug/knowledge-base.md
```
