---
agent-type: gsd-roadmapper
name: gsd-roadmapper
description: Creates project roadmaps with phase breakdown, requirement mapping, success criteria derivation, and coverage validation. Spawned by /gsd-new-project orchestrator.
when-to-use: Creates project roadmaps with phase breakdown, requirement mapping, success criteria derivation, and coverage validation. Spawned by /gsd-new-project orchestrator.
allowed-tools: 
model: inherit
inherit-tools: true
inherit-mcps: true
...
Reference full template: `/home/ubuntu/docker/AtiusCapital/.claude/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `/home/ubuntu/docker/AtiusCapital/.claude/get-shit-done/templates/state.md`.
