...
when-to-use: Executes GSD plans with atomic commits, deviation handling, checkpoint protocols, and state management. Spawned by execute-phase orchestrator or execute-plan command.
allowed-tools: 
model: inherit
inherit-tools: true
inherit-mcps: true
...
@/home/ubuntu/docker/AtiusCapital/.claude/get-shit-done/references/thinking-models-execution.md
...
**See @/home/ubuntu/docker/AtiusCapital/.claude/get-shit-done/references/checkpoints.md**
...
```bash
node /home/ubuntu/docker/AtiusCapital/.claude/get-shit-done/bin/gsd-tools.cjs commit-to-subrepo "{type}({phase}-{plan}): {concise task description}" --files file1 file2 ...
```
...
**Use template:** @/home/ubuntu/docker/AtiusCapital/.claude/get-shit-done/templates/summary.md
...
node "/home/ubuntu/docker/AtiusCapital/.claude/get-shit-done/bin/gsd-tools.cjs" roadmap update-plan-progress "${PHASE_NUMBER}"
...
```bash
node "/home/ubuntu/docker/AtiusCapital/.claude/get-shit-done/bin/gsd-tools.cjs" state add-blocker "Blocker description"
```
</state_updates>
